...
- Generate a two-host podcast script from any topic using Ollama
...
Requires this configuration in your `.env`:
...
| `--llm` | LLM model for script generation | uses `MODEL_NAME` from `.env` |
